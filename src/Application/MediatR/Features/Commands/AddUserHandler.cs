...
public class AddUserHandler : ICommandHandler<AddUserPostCommand, Unit>
{
    #region Поле
    ...
    public async Task<Unit> Handle(AddUserPostCommand command, CancellationToken cancellationToken)
    {
